...
const navItems: NavItem[] = [
  ...
  {
    // Stripe Connect — client-to-broker brokerage payment onboarding.
    // Separate from "מנוי וחיוב" (HYP SaaS subscription billing).
    label: "קבלת תשלומים",
    href:  "/settings/payments",
    // Bank/institution icon — visually distinct from the credit-card icons used
    // by "תשלומים" (/payments) and "מנוי וחיוב" (/settings/billing).
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
