...
const FAQS = [
  {
    ...
    a: "לא. SignDeal היא פלטפורמת עבודה לסוכני נדל״ן — כלי ניהול, חתימה וגבייה. היא אינה מהווה ייעוץ משפטי ואינה תחליף לעו״ד. תבניות החוזים מבוססות על מבנה מקובל בתיווך נדל״ן בישראל, אך לכל עסקה חריגה, מורכבת או בעלת השלכות משפטיות מיוחדות — פנו לעו״ד מוסמך.",
  },
  {
    q: "האם אפשר להשתמש בחוזים קיימים של המשרד?",
    a: "כרגע SignDeal עובדת עם תבניות החוזים המובנות במערכת — מותאמות לסוגים העיקריים של חוזי תיווך בישראל. בתוכנית Enterprise ניתן לדון בהתאמות מיוחדות לתבניות הייחודיות של המשרד שלכם. צרו קשר לפרטים.",
  },
  {
    q: "האם יש תיעוד לכל שליחה וחתימה?",
    a: "כן. המערכת שומרת רישום אוטומטי לכל פעולה: מתי החוזה נשלח, מתי הלינק נפתח, מתי בוצעה חתימה (כולל חותמת זמן וכתובת IP), ומתי התקבל תשלום. כל הנתונים נגישים ללוח הבקרה שלכם ונשמרים לאורך כל תקופת המנוי.",
  },
  {
    q: "האם החוזים תקפים משפטית בישראל?",
    a: "תבניות החוזים של SignDeal מיועדות להתאים לדרישות חוק המתווכים במקרקעין (תשנ\"ו-1996) וכוללות את הסעיפים המקובלים: זיהוי הצדדים, פרטי הנכס, שיעור העמלה ותנאי ההתקשרות. עם זאת, אנחנו לא מייעצים משפטית — לכל עסקה חריגה מומלץ להיוועץ בעו״ד.",
  },
  {
