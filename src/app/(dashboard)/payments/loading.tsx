/**
 * Loading skeleton for /payments page.
 */
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden" dir="rtl">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <div className="bg-white border-b border-gray-200 px-4 sm:px-8 py-4 shrink-0">
          <div className="h-6 w-28 bg-gray-200 rounded animate-pulse mb-1.5" />
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            {[...Array(6)].map((_, i) => (
              ...
              >
                ...
                <div className="h-4 bg-gray-200 rounded animate-pulse w-20 hidden sm:block" />
