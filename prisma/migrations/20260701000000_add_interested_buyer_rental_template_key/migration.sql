-- Migration: add INTERESTED_BUYER_RENTAL to the ContractTemplateKey enum
--
-- New user-facing rental variant of the interested-client flow. Resolved by
-- (contractType = "החתמת מתעניין", dealType = RENTAL) -> INTERESTED_BUYER_RENTAL.
--
...
ALTER TYPE "ContractTemplateKey" ADD VALUE IF NOT EXISTS 'INTERESTED_BUYER_RENTAL';
