-- Migration: add INTERESTED_BUYER_SALE to the ContractTemplateKey enum
--
-- New sale/purchase variant of the interested-client flow. Resolved by
-- (contractType = "החתמת מתעניין", dealType = SALE) -> INTERESTED_BUYER_SALE.
--
...
ALTER TYPE "ContractTemplateKey" ADD VALUE IF NOT EXISTS 'INTERESTED_BUYER_SALE';
