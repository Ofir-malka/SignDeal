-- Migration: add OWNER_EXCLUSIVE_SALE to the ContractTemplateKey enum
--
-- Sale variant of the owner-exclusive marketing mandate. Resolved by
-- (contractType = "החתמת בעל נכס / בלעדיות", dealType = SALE) -> OWNER_EXCLUSIVE_SALE.
--
...
ALTER TYPE "ContractTemplateKey" ADD VALUE IF NOT EXISTS 'OWNER_EXCLUSIVE_SALE';
