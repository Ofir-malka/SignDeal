-- Migration: add OWNER_SERVICE_ORDER_SALE to the ContractTemplateKey enum
--
-- Owner two-document family: the service-order agreement carries the fee terms
-- and is the primary document, resolved by (owner contractType + dealType SALE).
...
ALTER TYPE "ContractTemplateKey" ADD VALUE IF NOT EXISTS 'OWNER_SERVICE_ORDER_SALE';
